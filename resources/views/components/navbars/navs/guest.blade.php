            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2"
                        href="{{ in_array(request()->route()->getName(),['register', 'login', 'password.forgot', 'reset-password'])? route('register'): 'static-sign-up' }}">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2"
                        href="{{ in_array(request()->route()->getName(),['register', 'login', 'password.forgot', 'reset-password'])? route('login'): 'static-sign-in' }}">
